...
class QualificationServiceTest {
        ...
        void findQualification() {
                ...
                QualificationDto qualificationDto = new QualificationDto(1L, courseDto, "Description", null);
                ...
                when(qualificationMapper.toDto(qualification, courseDto)).thenReturn(qualificationDto);
        ...
        void instructorAddQualification_returnsDtoWithId_onSuccess() {
                ...
                CourseDto courseDto = new CourseDto(courseId, "HOSP", "Hospitality", "101");
                QualificationRequest req = new QualificationRequest(1L, courseId, 2L, "Food Safety", "HOSP");

                QualificationDto qualificationDto = new QualificationDto(99L, courseDto, "Food Safety", null);
        ...
        void findQualificationsByInstructorId_returnsDtosForEachSectionQualificationPair() {
                ...
                s2.setSection("001");
                s2.setType(SectionType.LECTURE);
                s2.setCourse(course);
                ...
                when(qualificationMapper.toQualificationWithSectionDto(s1, q1))
                                .thenReturn(new QualificationWithSectionDto(course.getId(), null, 100L, "COSC",
                                                "Java"));
                when(qualificationMapper.toQualificationWithSectionDto(s1, q2))
                                .thenReturn(new QualificationWithSectionDto(course.getId(), null, 101L, "COSC", "C++"));
                when(qualificationMapper.toQualificationWithSectionDto(s2, q1))
                                .thenReturn(new QualificationWithSectionDto(course.getId(), null, 100L, "COSC",
                                                "Java"));
                when(qualificationMapper.toQualificationWithSectionDto(s2, q2))
                                .thenReturn(new QualificationWithSectionDto(course.getId(), null, 101L, "COSC", "C++"));

                List<QualificationWithSectionDto> dtos = qualificationService
                                .findQualificationsByInstructorId(instructorId);
