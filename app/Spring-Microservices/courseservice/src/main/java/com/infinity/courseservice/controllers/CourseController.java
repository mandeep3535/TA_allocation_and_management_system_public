...
public class CourseController {
    ...
    // public ResponseEntity<List<CourseNeedAndAllocations>>
    // getInstructorCourseNeedsAndAllocations(
    // @PathVariable Long instructorId) {
    // return
    // ResponseEntity.ok(courseService.getInstructorCourseNeedsAndAllocations(instructorId));
    // }
