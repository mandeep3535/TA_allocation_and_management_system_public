...
public class EnrollmentController {
    ...
    @PutMapping("/section/{sectionId}/clear")
    public ResponseEntity<Integer> clearSection(@PathVariable Long sectionId) {
        int affected = enrollmentService.clearSectionFromStudentCourses(sectionId);
