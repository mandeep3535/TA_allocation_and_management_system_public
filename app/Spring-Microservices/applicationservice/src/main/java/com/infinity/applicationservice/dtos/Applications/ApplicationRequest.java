...
public record ApplicationRequest(
        ...
        @NotNull(message = "Working hour preferences not specified") @Min(value = 2, message = "The value must be greater than or equal to 2") @Max(value = 12, message = "The value must be less than or equal to 30") Integer wantWorkingHours,
