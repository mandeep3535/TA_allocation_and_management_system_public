...
import { Home, BookOpen, GraduationCap, User, LogOut, FileUser, FileQuestionMark, ShieldCheck , CalendarDays} from "lucide-react";
...
export default function SideNavStudent() {
  ...
  const navItems = [
    ...
    { label: "Schedule", to: "/user/student/schedule", icon: <CalendarDays size={22} /> },
